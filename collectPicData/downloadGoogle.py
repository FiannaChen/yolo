...
def parse_page(url):
    ...
    if page_content:
        ...
        # link_list = re.findall('([hH][tT]{2}[pP]://|[hH][tT]{2}[pP][sS]://|[wW]{3}.|[wW][aA][pP].)[-A-Za-z0-9+&@#/%?=~_|!:,.;]+[-A-Za-z0-9+&@#/%=~_|].jpg', page_content)
...
if __name__ == '__main__':
    ...
    p.close()
    p.join()
    # download_images(main_keywords[0], supplemented_keywords, download_dir)
